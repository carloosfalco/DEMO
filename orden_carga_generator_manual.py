...
def generar_orden_carga_manual():
    ...
    with st.form("orden_form"):
        ...
        if ida_vuelta:
            ...
            fecha_descarga_comun = fecha_carga_unica if entregar_de_seguido else fecha_carga_unica + timedelta(days=1)
            ...
            st.markdown("📅 Fecha de descarga")
            st.date_input("📅 Fecha de descarga común", value=fecha_descarga_comun, key="fecha_descarga_comun", disabled=True)
